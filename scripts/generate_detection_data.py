...
def generate_masks_and_annotations(data_dir, background_dir, class_annotation_file,
                                   ...
                                   augmentation_config_file_path, invert_mask, annotation_format):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', '-cp', required=True, type=str,
                        help='Path to a config file with augmentation parameters')
    ...
    try:
        generate_masks_and_annotations(args.data_directory, args.background_directory, args.class_annotations,
                                       ...
                                       args.config_path, args.invert_mask, args.annotation_format)
